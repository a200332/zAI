...
type
  ...
  TPictureViewerStyle = (pvsTop2Bottom, pvsLeft2Right);
...
begin
  ...
  FillBlackGrayBackgroundTexture(FBackgroundTex, 16);
end;
...
begin
  Result := InputPicture(Raster, texInfo, Instance_, True, False);
end;
