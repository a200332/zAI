...
uses
  ...
  CoreClasses, UnicodeMixedLib, PascalStrings, Geometry2DUnit, Geometry3DUnit,
  MemoryRaster, ListEngine, zDrawEngine, zDrawEngineInterface_SlowFMX;
...
function GetTextFont(text: string; siz: TGeoFloat; Color, EdgeColor: TDEColor; borderSiz: Integer): TMemoryRaster;
