...
begin
  ...
  TCompute.RunP_NP(procedure
    begin
      ...
      DoStatus('单元数量:%d', [ZDB.Space.PhyBlockNum]);
    end);
end;
...
begin
  ...
  ZDB.TraversalP(false, false, nil,
    procedure(ZSender: TZDB2; Traversal: TZDB2_Traversal; mem: TMem64; var Running: Boolean)
    begin
