unit zAI_RealTime_FACE_VideoServer;
        ...
        begin
          ...
          DelphiParallelFor(Low(face_Mat), high(face_Mat), procedure(pass: Integer)
            ...
            begin
              ...
              face_query_arry[pass].r := ai.Face_RectV2(face_hnd, pass);
...
begin
  ...
  // cpu worker
  face_det_para := TAI_Parallel.Create;
  face_det_para.Prepare_Parallel;
