...
function BuildDemoText1(spec: TPoint; var TextSource: U_String; var DrawCoordinate, BoundBoxCoordinate: TArrayV2R4): TRaster;
...
begin
  ...
  Result := NewRaster();
  Result.SetSize(800, 800, RColorF(0, 0, 0, 1));
  Result.OpenAgg;
